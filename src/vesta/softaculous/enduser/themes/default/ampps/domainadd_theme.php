...
<div class="bg">
	...
	<div class="row" '.($globals['os'] == 'windows' ? '' : ($softpanel->currentBinary() > 16 ? '' : 'style="display:none"')).'>
		<div class="col-sm-5">
			<label for="hostadd" class="sai_head">'.$l['host_entry'].'</label><br/><span class="sai_exp">'.$l['exp_hostadd'].($softpanel->isUAC() != 0 ? '</span><span class="sai_exp2"><font color=red>'.$l['hosts_perms'].'</font>' : '').'</span>
		</div>
