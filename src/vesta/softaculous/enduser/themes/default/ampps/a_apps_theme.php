...
global $software, $soft, $info, $settings, $init_tab, $installed, $removed, $__settings, $notes, $cron, $overwrite_option, $ampps_package, $nopackage, $install, $ampps_apps_installed, $currently_ruunning, $isMysql55installed, $show_warning_note, $info_path, $softinfo, $showDbWarning;
...
';
	...
	'.(empty($globals['ampps_lictype']) && !empty($a_apps[$soft]['ins']) ? '<br /><center class="alert alert-warning">'.lang_vars($l['notify_premium'], array($software['fullname'])).'</center>' : '').'
...
$softinfo=file_get_contents($info_path);
