...
$l['exp_conf_for_email'] = 'If checked then the same certificate will be used for in Exim and Dovecot for Email';
$l['error_no_le_domain'] = 'No domain found with Let\'s Encrypt Certificate installed on it';
$l['conf_cert'] = 'Configure';
$l['settings_saved'] = 'Your settings saved successfully';
$l['confirm_remove_le_cert_email'] = 'Do you want to remove the certificate configured for Email?';
$l['confirm_remove_le_cert_panel'] = 'Do you want to remove the certificate configured for Panel?';
