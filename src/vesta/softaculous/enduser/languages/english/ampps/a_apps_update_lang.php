...
$l['default_note'] = 'To update Defualt Applications run Ampps update.';

//Theme Strings
$l['note'] = 'Note:';
$l['note_uptodate'];
$l['note_update'] = 'You can not update';
$l['note_switch'] = 'while it is running so please change to different php version.';
$l['note_off'] = 'while it is running so turn off the process first.';
$l['update'] = 'Updating';
$l['app_name'] = 'App Name:';
...
$l['succesful'] = 'has been successfully Upgraded.';
...
$l['prog_upgrading'] = 'Upgrading Application';
$l['installing_update'] = 'Installing Update';
$l['downloading_package'] = 'Downloading Package';
$l['update_complete'] = 'Update Complete';
$l['upgrading'] = 'Updating Apps';
$l['upto_date'] = 'Upto Date !';
$l['upto_date2'] = 'This APP is already running latest version';
$l['restart_ampps'] = '<b>NOTE</b>: It may take few minutes to load Apps settings in AMPPS Control Panel';
$l['notify_premium'] = '<b>'.$software['fullname'].'</b> cannot be installed in the Free version of AMPPS. Please upgrade to the <b>AMPPS Premium</b>.';
?>